...
.focus-task {
  ...
  background:
    radial-gradient(circle at 88% 18%, rgba(255, 255, 255, 0.22) 0%, rgba(255, 255, 255, 0) 26%),
    linear-gradient(145deg, rgba(255, 255, 255, 0.18) 0%, rgba(255, 255, 255, 0.08) 100%);
  box-shadow: 0 24px 44px rgba(69, 78, 175, 0.18);
...
.task-row__meta span {
  background: rgba(142, 140, 245, 0.08);
  border: 1px solid rgba(138, 153, 230, 0.16);
  color: #6271a4;
}
...
.signal-card {
  ...
  overflow: hidden;
  background:
    radial-gradient(circle at top right, rgba(171, 231, 223, 0.22) 0%, rgba(171, 231, 223, 0) 28%),
    linear-gradient(150deg, rgba(255, 255, 255, 0.86) 0%, rgba(241, 244, 255, 0.96) 58%, rgba(234, 248, 245, 0.96) 100%);
}
...
.summary-item {
  ...
  border: 1px solid rgba(138, 153, 230, 0.14);
  background: linear-gradient(145deg, rgba(255, 255, 255, 0.7) 0%, rgba(237, 242, 255, 0.9) 100%);
...
.assignment-row {
  border-radius: var(--radius-lg);
  border: 1px solid rgba(138, 153, 230, 0.18);
  background: linear-gradient(150deg, rgba(255, 255, 255, 0.8) 0%, rgba(243, 246, 255, 0.94) 56%, rgba(238, 250, 247, 0.96) 100%);
  box-shadow: 0 18px 36px rgba(118, 121, 199, 0.12);
...
.course-card {
  padding: 22px;
  background:
    radial-gradient(circle at top right, rgba(142, 140, 245, 0.12) 0%, rgba(142, 140, 245, 0) 24%),
    linear-gradient(180deg, rgba(255, 255, 255, 0.86) 0%, rgba(243, 246, 255, 0.95) 52%, rgba(236, 249, 246, 0.96) 100%);
}
...
.quick-action-card {
  background:
    radial-gradient(circle at top right, rgba(142, 140, 245, 0.14) 0%, rgba(142, 140, 245, 0) 28%),
    linear-gradient(150deg, rgba(255, 255, 255, 0.84) 0%, rgba(239, 243, 255, 0.96) 56%, rgba(235, 248, 245, 0.98) 100%);
}

.notice-card {
  background:
    radial-gradient(circle at top right, rgba(171, 231, 223, 0.18) 0%, rgba(171, 231, 223, 0) 30%),
    linear-gradient(150deg, rgba(255, 255, 255, 0.82) 0%, rgba(244, 247, 255, 0.96) 100%);
}

.status-card {
  background:
    radial-gradient(circle at top right, rgba(171, 231, 223, 0.18) 0%, rgba(171, 231, 223, 0) 28%),
    linear-gradient(150deg, rgba(255, 255, 255, 0.84) 0%, rgba(241, 245, 255, 0.96) 52%, rgba(235, 249, 245, 0.98) 100%);
}
