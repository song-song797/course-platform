...
<template>
  <div class="page-shell detail-page detail-page--submission" v-if="assignment">
    <section class="page-head">
      <div class="page-head__main">
        <span class="page-head__eyebrow">作品提交</span>
        <h2 class="page-head__title">录入项目链接、附件与说明信息</h2>
        <p class="page-head__description">
          集中维护仓库、视频、预览、文档和补充说明，教师评分与同学互评一体化。
        </p>
    ...
    <div class="content-grid">
      <div class="section-card section-card--accent detail-form-panel">
        <el-alert
        ...
        <el-form :model="form" label-position="top" style="margin-top: 18px;">
          ...
          <el-form-item label="附件">
            <div class="toolbar detail-attachment-toolbar" style="width: 100%; align-items: flex-start;">
