...
CREATE TABLE IF NOT EXISTS course (
    ...
    course_deadline TIMESTAMP NULL
);

ALTER TABLE course ADD COLUMN IF NOT EXISTS course_deadline TIMESTAMP NULL;
...
ALTER TABLE assignment ADD COLUMN IF NOT EXISTS results_published BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE assignment ADD COLUMN IF NOT EXISTS results_published_at TIMESTAMP NULL;
...
ALTER TABLE evaluation ADD COLUMN IF NOT EXISTS review_status VARCHAR(32) NOT NULL DEFAULT 'PENDING';
